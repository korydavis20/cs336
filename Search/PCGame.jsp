...
<body>
	<center>PC Games</center> <br>
	<form method="post" action="sortPG.jsp">
	<td>SortBy</td>
	...
	String str = "SELECT A.auction_id, A.game_title, A.price FROM Auction_Site.Auctions A WHERE A.device_type = 'pc'";
